<div class="row">
	<div class="col-md-12">
        ...
        <div class="box box-primary">
            ...
            <!-- form start -->
            <form role="form" action="<?php echo site_url('fronts/gallery/update_pic')?>" method="post" enctype="multipart/form-data">
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="descr" class="form-control txteditor" id="descr" placeholder="Desc" rows="10" value="<?php echo $gallery['descr'];?>"> </textarea>
                    </div>
                     <div class="control-group">
                            ...
                            <img src="<?php echo base_url('uploads/'.$gallery['img']);?>" style="width:200px;height:75px" alt=  "No image" /><br>
                    </div> 
...
$(document).ready(function(){
    ...
    $('.txteditor').Editor("setText", "<?php echo !empty($gallery['descr']) ? addslashes($gallery['descr']) :'';?>");        
})
